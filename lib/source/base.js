...
class BaseSource {
    ...
    async getApi(url) {
        ...
        const apiResponse = await axios.get(url, { responseType: 'json', timeout: 2000, headers: { 'User-Agent': 'Mozilla/5.0 (xxxx Windows NT 10.0; Win64; x64)' } });
